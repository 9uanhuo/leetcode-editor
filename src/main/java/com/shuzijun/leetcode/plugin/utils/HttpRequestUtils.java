...
public class HttpRequestUtils {
    ...
    private static final MyExecutorHttp executorHttp = new MyExecutorHttp();
    private static final LcClient enLcClient = LcClient.builder(HttpClient.SiteEnum.EN).executorHttp(executorHttp).build();
    private static final LcClient cnLcClient = LcClient.builder(HttpClient.SiteEnum.CN).executorHttp(executorHttp).build();
    ...
    private static class MyExecutorHttp extends DefaultExecutoHttp {
        ...
        private MyExecutorHttp() {
            this.proxyHttpClient = IdeaProxyConfigurator.applyIdeaProxy(super.getRequestClient().newBuilder()).build();
        }
